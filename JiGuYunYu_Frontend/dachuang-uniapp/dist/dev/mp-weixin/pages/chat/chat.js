...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const artifactName = common_vendor.ref("");
    ...
    const handleSend = async () => {
      ...
      try {
        const res = await common_api_index.dialogApi.createRequest({
          query: message,
          artifactId: artifactId.value ? Number(artifactId.value) : void 0,
        ...
        if (!aiResponse && dialogId) {
          const result = await common_api_index.dialogApi.getResult(dialogId);
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: common_vendor.o(handleClearHistory, "b7"),
        ...
        i: isLoading.value,
        j: common_vendor.o(handleSend, "c5"),
        k: inputMessage.value,
        l: common_vendor.o(($event) => inputMessage.value = $event.detail.value, "4c"),
        m: !canSend.value ? 1 : "",
        n: common_vendor.o(handleSend, "03"),
        o: common_vendor.p({
          visible: false
        })
      });
