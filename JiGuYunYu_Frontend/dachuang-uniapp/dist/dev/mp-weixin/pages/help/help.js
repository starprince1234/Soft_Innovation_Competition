  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: common_vendor.o(($event) => searchKeyword.value = $event.detail.value, "ab"),
        ...
        d: common_vendor.o(($event) => openGuide("识别指南"), "1a"),
        e: common_vendor.o(($event) => openGuide("收藏指南"), "75"),
        f: common_vendor.o(($event) => openGuide("问答指南"), "2a")
      };
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-febba6ee"]]);
