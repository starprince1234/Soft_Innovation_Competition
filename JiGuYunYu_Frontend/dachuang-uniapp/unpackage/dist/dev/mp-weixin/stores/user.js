...
const useUserStore = common_vendor.defineStore("user", {
  ...
  getters: {
    ...
    userRole: (state) => {
      var _a, _b;
      return ((_b = (_a = state.userInfo) == null ? void 0 : _a.roles) == null ? void 0 : _b[0]) || "";
    },
    userId: (state) => {
      var _a;
  ...
  actions: {
    ...
    setRefreshToken(refreshToken) {
      ...
      common_vendor.index.setStorageSync(common_constants_index.STORAGE_KEYS.REFRESH_TOKEN, refreshToken);
    },
    ...
    initFromStorage() {
      ...
      const refreshToken = common_vendor.index.getStorageSync(common_constants_index.STORAGE_KEYS.REFRESH_TOKEN);
