  ...
  setup(__props) {
    ...
    const handleChooseImage = async () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/feedback/feedback.vue:140", "选择图片失败:", error);
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/feedback/feedback.vue:201", "提交反馈失败:", error);
        common_vendor.index.showToast({
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: common_vendor.o(($event) => formData.value.textContent = $event.detail.value),
        ...
        k: common_vendor.o(($event) => formData.value.contact = $event.detail.value),
