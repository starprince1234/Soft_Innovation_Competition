          ...
          <view class="rating-container">
            ...
            <view class="rating-stars">
              <image
                ...
                :key="i"
                class="star"
                :src="i <= formData.rating ? starFilledIcon : starOutlineIcon"
                mode="aspectFit"
          ...
          <view class="upload-container">
            ...
            >
              ...
              <view class="delete-btn" @click="deleteImage(index)">
                <image class="delete-icon" :src="closeIcon" mode="aspectFit"></image>
              </view>
            </view>
            <view
            ...
            >
              <image class="upload-icon" :src="addIcon" mode="aspectFit"></image>
...
const closeIcon = resolveAssetPath('/static/icons/close.svg')
const addIcon = resolveAssetPath('/static/icons/add.svg')
...
const feedbackTypes = [
  { label: '功能异常', value: 'BUG', icon: resolveAssetPath('/static/icons/feedback-bug.svg') },
  { label: '功能建议', value: 'FEATURE_REQUEST', icon: resolveAssetPath('/static/icons/feedback-feature.svg') },
  { label: '内容错误', value: 'CONTENT_ERROR', icon: resolveAssetPath('/static/icons/feedback-content.svg') },
  { label: '其他', value: 'GENERAL', icon: resolveAssetPath('/static/icons/feedback-general.svg') }
]
