        ...
        <view class="faq-list">
          <view class="faq-item" v-for="(faq, index) in filteredFaqs" :key="index">
            <view class="faq-question" @click="toggleFaq(index)">
              ...
              <image
                class="faq-arrow"
                :src="faq.expanded ? chevronDownIcon : chevronRightIcon"
                mode="aspectFit"
              ></image>
            </view>
      ...
      <view class="help-section">
        ...
        <view class="guide-list">
          <view class="guide-item" @click="openGuide('识别指南')">
            <image class="guide-icon" :src="mobileIcon" mode="aspectFit"></image>
            <text class="guide-text">如何使用文物识别功能</text>
            <image class="guide-arrow" :src="chevronRightIcon" mode="aspectFit"></image>
          </view>
          <view class="guide-item" @click="openGuide('收藏指南')">
            <image class="guide-icon" :src="favoriteIcon" mode="aspectFit"></image>
            <text class="guide-text">如何收藏文物</text>
            <image class="guide-arrow" :src="chevronRightIcon" mode="aspectFit"></image>
          </view>
          <view class="guide-item" @click="openGuide('问答指南')">
            <image class="guide-icon" :src="chatIcon" mode="aspectFit"></image>
      ...
      <view class="help-section">
        ...
        <view class="contact-section">
          <view class="contact-item">
            <image class="contact-icon" :src="emailIcon" mode="aspectFit"></image>
            <text class="contact-text">邮箱：support@jiguyunyu.com</text>
          </view>
          <view class="contact-item">
            <image class="contact-icon" :src="phoneIcon" mode="aspectFit"></image>
            <text class="contact-text">电话：400-123-4567</text>
          </view>
          <view class="contact-item">
            <image class="contact-icon" :src="clockIcon" mode="aspectFit"></image>
...
const mobileIcon = resolveAssetPath('/static/icons/mobile.svg')
const favoriteIcon = resolveAssetPath('/static/icons/favorite.svg')
const chatIcon = resolveAssetPath('/static/icons/chat.svg')
const emailIcon = resolveAssetPath('/static/icons/email.svg')
const phoneIcon = resolveAssetPath('/static/icons/phone.svg')
const clockIcon = resolveAssetPath('/static/icons/clock.svg')
const chevronRightIcon = resolveAssetPath('/static/icons/chevron-right.svg')
const chevronDownIcon = resolveAssetPath('/static/icons/chevron-down.svg')
